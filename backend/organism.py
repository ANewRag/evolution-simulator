...
class Organism:
    ...
    def mutate(self, mutation_strength):
        ...
        child_speed = max(1, random.gauss(self.speed, mutation_strength))
        child_size = max(1, random.gauss(self.size, mutation_strength))
...
class Prey(Organism):
    def __init__(self, speed=1, size=1, x=0, y=0):
        super().__init__(speed=speed, size=size, x=x, y=y, move_cost=size+speed)
        self.type = "Prey"
...
class Predator(Organism):
    def __init__(self, speed=1, size=1, x=0, y=0):
        super().__init__(speed, size, x, y, move_cost=size+speed)
        self.type = "Predator"
